...
<body>
    ...
    <div>
        <form method="POST">
            ...
            <input type="password" id="confirm" name="confirm" pattern="(?=.*\d)(?=.*[a-z])(?=.*?[#?!@$%^&*-\]\[]).{8,}" title="The password must be 8 characters, at least one letter, one number, and one special character."><br><br>
